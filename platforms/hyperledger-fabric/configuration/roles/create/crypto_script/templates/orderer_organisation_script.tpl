...
cat ${ORG_CYPTO_FOLDER}/msp
ls ${ORG_CYPTO_FOLDER}/msp
...
ls ${ORG_CYPTO_FOLDER}/msp/tlscacerts
...
ls ${ORG_CYPTO_FOLDER}/msp/admincerts
...
mkdir -p ${ORG_CYPTO_FOLDER}/users/${ORG_ADMIN_USER}/tls
    ...
    cat ${ORG_CYPTO_FOLDER}/users/${ORG_ADMIN_USER}/tls
    ls ${ORG_CYPTO_FOLDER}/users/${ORG_ADMIN_USER}/tls
...
cd ${CURRENT_DIR}
 ...
 echo "after chanssssssssging dir"
    echo $(pwd)
