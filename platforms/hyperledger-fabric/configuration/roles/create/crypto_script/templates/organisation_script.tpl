...
while [  ${COUNTER} -lt ${NO_OF_PEERS} ]; do
	...
	${ORG_CYPTO_FOLDER}/peers/${PEER}/tls
	...
	ls ${ORG_CYPTO_FOLDER}/peers/${PEER}/msp/tlscacerts
	...
	${ORG_CYPTO_FOLDER}/peers/${PEER}/msp/tlscacerts
